...
import { convert, leadController, moveLeadStage, updateLead } from "../controllers/leadController.js";
...
router.patch("/:id", authorize(...salesRoles), updateLead);
router.put("/:id", authorize(...salesRoles), updateLead);
