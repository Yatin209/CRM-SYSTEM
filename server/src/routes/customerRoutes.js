...
router.patch("/:id", authorize("Administrator", "Manager", "Sales Executive", "Customer Support Executive"), 
  [
  ...
  validate,
  controller.update);
router.put("/:id", authorize("Administrator", "Manager", "Sales Executive", "Customer Support Executive"),
  [
    body("name").optional().isString(),
    body("company").optional().isString(),
    body("email").optional().isEmail().normalizeEmail(),
