...
const demoUsers = [
  { name: "Aarav Mehta", email: "admin@nexacrm.com",   role: "Administrator",              region: "Global",      performance: 96 },
  { name: "Mira Shah",   email: "manager@nexacrm.com", role: "Manager",                    region: "West India",  performance: 91 },
  { name: "Rohan Iyer",  email: "sales@nexacrm.com",   role: "Sales Executive",            region: "Mumbai",      performance: 88 },
  { name: "Kavya Nair",  email: "support@nexacrm.com", role: "Customer Support Executive", region: "Bengaluru",   performance: 84 },
];
